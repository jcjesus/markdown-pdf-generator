...
async def main():
    ...
    print("   1. Edite config.yaml para personalizar configurações")
    print("   2. Use metadata YAML nos seus documentos")
    print("   3. Crie templates personalizados")
    print("   4. Configure alinhamentos e estilos")
